...
.controller('examTripTimeEstimatorCtrl', ['$scope', '$http', '$q', 'examTripTimeEstimatorFactory', function ($scope, $http, $q,
examTripTimeEstimatorFactory) {
    ...
    $scope.insertValue = examTripTimeEstimatorFactory.insertValue;
    $scope.loading = examTripTimeEstimatorFactory.loading;
    $scope.links = examTripTimeEstimatorFactory.links;
    $scope.openDataExampleData = examTripTimeEstimatorFactory.openDataExampleData;
    $scope.dbData = examTripTimeEstimatorFactory.dbData;
    $scope.item = examTripTimeEstimatorFactory.item;
    ...
    examTripTimeEstimatorFactory.init($scope);
    ...
    .factory('examTripTimeEstimatorFactory', ['$http', '$rootScope', '$filter', '$q', function ($http, $rootScope,
        $filter, $q) {
        var initialized = {
            value: false
        };
    ...
    .directive('examTripTimeEstimatorDirectiveName', ['$http', function ($http) {
        return {
    ...
    .filter('examTripTimeEstimatorFilterName', function () {
